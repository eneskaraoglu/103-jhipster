...
describe('Authority e2e test', () => {
  ...
  const authoritySample = { name: '6ed2ac7a-af3f-4dde-979f-eb105b64d798' };
  ...
  describe('new Authority page', () => {
    ...
    it('should create an instance of Authority', () => {
      cy.get(`[data-cy="name"]`).type('2e1683c8-01c2-4166-9724-de26ca1c7e97');
      cy.get(`[data-cy="name"]`).should('have.value', '2e1683c8-01c2-4166-9724-de26ca1c7e97');
